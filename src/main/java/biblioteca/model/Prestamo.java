...
public class Prestamo {
    ...
    public String obtenerInformacionCompleta() {
        // Utiliza StringBuilder para eficiencia en la construcción de cadenas
        StringBuilder informacion = new StringBuilder();
        informacion.append(String.format("Libro: %s\n", libro.getTitulo()));
        informacion.append(String.format("Autor: %s\n", libro.getAutor()));
        informacion.append(String.format("Usuario: %s\n", usuario.getNombreCompleto()));  // Cambié getNombre() a getNombreCompleto() para ser consistente
